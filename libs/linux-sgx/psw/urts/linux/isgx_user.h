...
#define SGX_IOC_ENCLAVE_PSETUP \
	_IOW(SGX_MAGIC, 0x03, struct sgx_enclave_pginfo)
#define SGX_IOC_ENCLAVE_PSWOUT \
	_IOW(SGX_MAGIC, 0x04, struct sgx_enclave_pgswap)
#define SGX_IOC_ENCLAVE_PSWIN \
	_IOW(SGX_MAGIC, 0x05, struct sgx_enclave_pgswap)
#define SGX_IOC_ENCLAVE_VATRANS \
 	_IOW(SGX_MAGIC, 0x06, struct sgx_enclave_vatrans)
