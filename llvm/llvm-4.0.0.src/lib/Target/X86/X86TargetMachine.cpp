...
static cl::opt<bool>
UseObfuscuroCode("obfuscuro-inst-code", cl::Hidden,
              cl::desc("Rerandomize code"),
              cl::init(false));
...
void X86PassConfig::addPreRegAlloc() {
  ...
  addPass(createX86ObfuscuroRedirectMemAccess());
}
...
/*
  if (UseObfuscuroCode)
  {
    addPass(createX86Obfuscuro()); // the sequence does matter
  }
*/
    addPass(createX86Obfuscuro()); // the sequence does matter
}
