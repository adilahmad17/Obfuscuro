...
bool X86AsmPrinter::runOnMachineFunction(MachineFunction &MF) {
  ...
  isOblivious = MF.getFunction()->hasFnAttribute("oblivious");
  obliviousFirstLabelEmitted = false;

  maximumCallFrameSize = FrameInfo->getMaxCallFrameSize();

  //instrumenter.reset(MF);
