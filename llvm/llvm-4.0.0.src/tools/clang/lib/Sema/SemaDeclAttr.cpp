...
// Added by Adil
// Attribute handler for Oblivious
static void handleObliviousAttr(Sema &S, Decl *D, const AttributeList &Attr)
{
  D->addAttr(::new (S.Context) ObliviousAttr(Attr.getRange(), S.Context,
        Attr.getAttributeSpellingListIndex()));
  return;
}
// end changes
...
static void ProcessDeclAttribute(Sema &S, Scope *scope, Decl *D,
  ...
  default:
    ...
    break;
  case AttributeList::AT_Oblivious:
    // added by Adil
    handleObliviousAttr(S, D, Attr);
    break;
