...
static bool HasFeature(const Preprocessor &PP, StringRef Feature) {
  ...
  return llvm::StringSwitch<bool>(Feature)
      ...
      .Case("rerand", LangOpts.Sanitize.has(SanitizerKind::Rerand))
      .Case("rerand-stack", LangOpts.Sanitize.has(SanitizerKind::RerandStack))
      .Case("rerand-code", LangOpts.Sanitize.has(SanitizerKind::RerandCode))
