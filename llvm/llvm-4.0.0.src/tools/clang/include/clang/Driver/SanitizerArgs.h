...
class SanitizerArgs {
  ...
  bool RerandSharedRuntime = false;
 ...
 public:
  ...
  bool needsRerandRt() const { return Sanitizers.has(SanitizerKind::Rerand); }
  bool needsSharedRerandRt() const { return RerandSharedRuntime; }
