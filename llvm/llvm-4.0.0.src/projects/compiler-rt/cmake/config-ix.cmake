...
set(ALL_RERAND_SUPPORTED_ARCH ${X86_64})
...
if(APPLE)
  ...
  list_intersect(SAFESTACK_SUPPORTED_ARCH
    ...
    SANITIZER_COMMON_SUPPORTED_ARCH)
  list_intersect(RERAND_SUPPORTED_ARCH
    ALL_RERAND_SUPPORTED_ARCH
    SANITIZER_COMMON_SUPPORTED_ARCH)
  ...
  filter_available_targets(SAFESTACK_SUPPORTED_ARCH
    ${ALL_SAFESTACK_SUPPORTED_ARCH})
  filter_available_targets(RERAND_SUPPORTED_ARCH ${ALL_RERAND_SUPPORTED_ARCH})
...
set(ALL_SANITIZERS asan;dfsan;msan;tsan;safestack;cfi;esan;scudo;rerand)
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND RERAND_SUPPORTED_ARCH AND
    OS_NAME MATCHES "Linux")
  set(COMPILER_RT_HAS_RERAND TRUE)
else()
  set(COMPILER_RT_HAS_RERAND FALSE)
endif()
